  ...
  const handleCompleteLesson = async (lessonId) => {
    try {
      ...
      setCourse((prevCourse) => {
        ...
        const totalLessons = prevCourse.lessons.length || 1; // avoid division by zero
        const completedCount = currentStudent?.lessons.length || 0;
        const newProgress = Math.floor((completedCount / totalLessons) * 100);
        setProgress(newProgress > 100 ? 100 : newProgress); // cap only if >100
